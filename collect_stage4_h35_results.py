...
def load_one(exp_dir: Path) -> dict | None:
    ...
    if meta_json.exists():
        try:
            ...
            row["test_windows"] = int(cf.get("test_windows_after", 0))
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Collect stage4 h35 week4-6 experiment metrics")
    ap.add_argument("--results_root", type=str, default="results/stage4_extended_h35_week46")
    ap.add_argument("--out_csv", type=str, default="results/stage4_extended_h35_week46/stage4_h35_week46_summary.csv")
    args = ap.parse_args()
    ...
    print("=" * 80)
    print("STAGE4 H35 WEEK4-6 SUMMARY")
    print("=" * 80)
