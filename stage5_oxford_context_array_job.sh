#!/bin/bash
#SBATCH --job-name=crt-s5-ctx
#SBATCH --output=slurm-stage5-ctx-%A_%a.out
#SBATCH --error=slurm-stage5-ctx-%A_%a.err
...
CKPT_DIR="checkpoints/oxford_stage5_context/${EXP_NAME}"
EXT_RESULT_DIR="results/stage5_context_extended/${EXP_NAME}"

echo "Running Stage 5 context experiment: $EXP_NAME"
